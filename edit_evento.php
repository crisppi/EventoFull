        ...
        <form class="formulario" action="<?= $BASE_URL ?>process_evento.php" id="add-movie-form" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group col-sm-10">
                        ...
                        <textarea rows="10" class="form-control" id="rel_prolongamento" value="<?= $evento->rel_prolongamento ?>" name="rel_prolongamento"></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="form-group col-sm-2 ">
                    ...
                    <div class="form-group col-sm-10">
                        ...
                        <textarea rows="10" class="form-control" value="<?= $evento->rel_impacto ?>" id="rel_impacto" name="rel_impacto"></textarea>
                    </div>
                </div>
                <div class="form-group col-sm-2 ">
            ...
            <div class="form-group row">
                <div class="form-group col-sm-12">
                    ...
                    <textarea rows="10" class="form-control" type="text" id="rel_evento" value="<?= $evento->rel_evento ?>" name="rel_evento"></textarea>
                </div>
            </div>
    </div>
