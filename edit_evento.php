        ...
        <!-- <form class="formulario" action="<?= $BASE_URL ?>process_evento.php" id="add-evento-form" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <div class="form-group col-sm-4">
                    ...
                    <input type="text" class="form-control" id="paciente" value="<?= $evento->paciente ?>" name="paciente" placeholder="Digite o nome do paciente">
                </div>
                <div class="form-group col-sm-1">
                    <label for="idade">Idade</label>
                    <input type="text" class="form-control" id="idade" value="<?= $evento->idade ?>" name="idade" placeholder="Digite a idade">
                ...
                <div class="form-group col-sm-1 ">
                    <label class="control-label" for="sexo">Sexo</label>
                    <select class="form-control" id="sexo" name="sexo">
                        <option value="<?= $evento->sexo ?>">Selecione</option>
