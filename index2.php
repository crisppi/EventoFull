...
<div style="background-color:#e9e9e9">
    <div class="col-md-6 col-12">
        <div class="row full-height justify-content-center">
            <div class="col-6 col-xxl-5 align-self-center">
                <h2 class="display-5">Login</h2>
                <p class="lead mb-4">Faça o login para continuar</p>
                <form method="post">
                    <input class="input border-0 border-bottom p-2" style="border-radius:10px" name="email_login" id="email_login" placeholder="E-mail" type="text" />
                    <br />
    ...
    <?php } ?>
    <div class="row d-flex icons justify-content-around">
        <div class="md-6">
