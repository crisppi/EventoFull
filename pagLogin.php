...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_err) && empty($password_err)) {
        ...
        $sql = "SELECT id_usuario, usuario_user, password FROM tb_user WHERE usuario_user = :username";
                ...
                if ($stmt->rowCount() == 1) {
                    if ($row = $stmt->fetch()) {
                        ...
                        if (password_verify($password, $hashed_password)) {
                            ...
                            $_SESSION["usuario_user"] = $ussername;
...
<body>
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                <label>Senha</label>
                <input type="password" name="senha_user" class="form-control <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>">
